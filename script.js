...
if (saveContactBtn) {
  ...
  // This is what Save Contact copies.
  ...
  // Rich version for apps that support HTML clipboard content.
  const allContactHtml = `
    <table style="border-collapse:collapse;font-family:Arial,sans-serif;font-size:14px;color:#222">
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Name</td>
        <td style="padding:4px 0">Kas T. Kallie</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Company</td>
        <td style="padding:4px 0">DeXM Management</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Title</td>
        <td style="padding:4px 0">Operating Partner</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Phone</td>
        <td style="padding:4px 0">+1 917 523 0461</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Email</td>
        <td style="padding:4px 0">kas@dexm-m.com</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">Website</td>
        <td style="padding:4px 0">https://www.dexm-m.com</td>
      </tr>
      <tr>
        <td style="padding:4px 16px 4px 0;font-weight:600">LinkedIn</td>
        <td style="padding:4px 0">https://www.linkedin.com/in/kaskallie</td>
      </tr>
    </table>
  `;
  ...
  async function copyEverything() {
    ...
    try {
      ...
      // Rich clipboard where supported.
      if (
      ...
      const label =
        saveContactBtn.querySelector('.action-label');
      ...
      console.error(
        'Could not copy contact information:',
        err
      );
    }
  }
  ...
  // Save Contact copies everything.
  ...
  card
    ...
    .forEach((value) => {
      ...
      value.addEventListener('click', async (e) => {
        ...
        // Use the actual URL/phone/email from href.
